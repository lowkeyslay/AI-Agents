...
class Agent:
    ...
    def think(self, prompt):
        ...
        agent_system_prompt = agent_prompt.format(tool_descriptions=tool_descriptions)
        ...
        agent_response_dict = model_instance.get_response(prompt)
...
if __name__ == "__main__":
    ...
    tools = [code_generator, code_explainer]


    model_service = GPTClient
    model_name = 'gpt-4o'
    stop = None
